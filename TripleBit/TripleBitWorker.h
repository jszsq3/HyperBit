...
private:
	...
	vector<TripleNode> insertNodes; //´ý²åÈëÊý¾Ý
...
public:
	...
	Status NTriplesParse(const char* subject, const char* predicate, const char* object, const char* time, TripleNode& tripleNode);
	void Work();
	void Print();
};
