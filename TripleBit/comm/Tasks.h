...
public:
	...
	ChunkTask(timeval &chunkTaskTime, TripleBitQueryGraph::OpType opType, ID subjectID, ID predicateID, ID objectID, ID timeID,
	...
	ChunkTask(TripleBitQueryGraph::OpType opType, ID subjectID, ID predicateID, ID objectID, ID timeID,
