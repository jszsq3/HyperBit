...
void TripleBitWorker::parse(string &line, string &subject, string &predicate, string &object, string& time) {
	int l, r;
...
Status TripleBitWorker::NTriplesParse(const char* subject, const char* predicate, const char* object, const char* time, TripleNode& tripleNode) {
