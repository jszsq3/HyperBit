...
LIBS := -lpthread -lboost_system -lboost_thread -L/usr/local/lib -ltcmalloc -lleveldb -lsnappy
...
modules      := TripleBit BuildTripleBitFromN3 TripleBitQuery TripleBitInsert
programs     := 
libraries    :=
sources      :=
