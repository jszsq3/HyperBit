...
{ // rawFacts = <SID,PID,OID,TID>...
  ...
  sta_two_op->temp_map[objectID][predicateID]++;
  ...
  cout<<"sta_two_sp->temp_map.size() : "<<sta_two_sp->temp_map.size()<<endl;
  cout<<"sta_two_op->temp_map.size() : "<<sta_two_op->temp_map.size()<<endl;
  //计算快照位置
  // cout<<"计算快照位置"<<endl;
